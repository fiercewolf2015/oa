	 ...
	 <div class="row" style="padding:45px 20px 20px 20px">
         <div id="saveDiv" style="max-width:820px;margin:auto;overflow-x:auto;">
                 <div class="panel panel-primary" style="width:820px;">
                     <div class="panel-heading"  style="text-align:center;font-size:18px;">文件阅办单<span style="float: right;margin-right: 10px;cursor: pointer;" onclick="showWorkFlow('${liId}')" >查看流程</span></div>
                        ...
                        <div class="oneRowDiv" style="height:100px;">
                         ...
                         <div class="twoRowDiv" style="height:115px;">
								...
								<div class="form-group formDiv" style="float:left;width:58%;">
									...
									<input id="fileNo" name="fileNo" class="formSpan transform " style="width:76%"/>
								</div>
								<div class="form-group formDiv" style="float:left;width:42%;">
									<label class="formLabel">收文编号:</label>
									<input id="accessfileNo" name="accessfileNo" type="text" class="formSpan transform " style="float:left;width:142px;height:26px;"/>
								</div>
								<div class="form-group formDiv" style="float:left;width:58%;">
									<label class="formLabel">收文份数:</label>
									<input id="fileCount" name="fileCount" class="formSpan transform " style="width:76%"/>
								</div>
								<div class="form-group formDiv" style="float:left;width:42%;">
									<label class="formLabel">紧急程度:</label>
									<select id="fileLevel" name="fileLevel" class="form-control transform" style="width: 143px;">
										<option value="常规公文">常规公文</option>
										<option value="紧急公文">紧急公文</option>
										<option value="特急公文">特急公文</option>
									</select>
								</div>
						　</div>
						...
						　<div class="twoRowDiv" style="height:auto;margin-top:30px;">
						 ...
						 <div class="col-xs-12" style="float:left;">
							<div class="form-group" id="saveAndCancelDiv" style="float:right;">
				        	 	<button type="button" class="btn btn-primary btn-sm" style="margin-right:10px;" onclick="saveDiv(3);">提交</button>
